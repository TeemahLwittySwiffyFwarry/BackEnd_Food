...
class userCreateSerializer(serializers.ModelSerializer):
    ...
    def validate(self, data):
        ...
        # print("this is the person" + data['email'])
    ...
    def create(self, data):
        pwd = data['password']
        encrypted_pwd = make_password(pwd, "hhhhsggdyoqojwhyuwhbshjsjsgsg")
        ...
        if verify_user is None:
            ...
            if check == True:
                data = {
                    ...
                    "lastname": getattr(verify_user, "last_name")
                }
                return data
            else:
                raise ValueError ("Invalid Credentials")
            ...
            # print(encrypted_pwd)
            return data
        # pwd = getattr(verify_user, "password")
        # fname = getattr(verify_user, "first_name")
        # print(pwd)
        # print(fname)
        # print(verify_user)
        return data